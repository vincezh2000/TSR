...
class ReRaLSTM:
    ...
    def train(self):
        ...
        with tf.device(device_name):
            ...
            # 为什么要定义rel_mask呢？因为+上rel_mask后，就是非常小的负数。
            # 代表没有关联关系，激活后为0，没有必要进行信息聚合
            # 一下softmax对应论文中的e-bar = g/d * e 中的 g/d
